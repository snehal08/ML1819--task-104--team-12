...
data = pd.read_csv('E:\Mushroom\data\mushrooms3.csv')
...
counts=data_test['class'].value_counts()
...
Poisonous_Odor = data_test[data['class'] == 'p']['odor'].value_counts()
...
Edible_Odor = data_test[data['class'] == 'e']['odor'].value_counts()
...
Label = data_test['class']
Features = data_test.drop(['class'],axis=1)
...
for name, model in mushroom:
    f1_score_of_model = cross_val_score(model, X_test, y_test, cv=10, scoring=ftwo_scorer)
...
#     acc_of_model_2 = cross_val_score(model, X_test2, y_test2, cv=10, scoring='accuracy')
#
...
#
# for name, model in mushroom2:
#     f1_score_of_model_2 = cross_val_score(model, X_test2, y_test2, cv=10, scoring=ftwo_scorer)
#
...
#     acc_of_model_3 = cross_val_score(model, X_test3, y_test3, cv=10, scoring='accuracy')
#
...
#
# for name, model in mushroom3:
#     f1_score_of_model_3 = cross_val_score(model, X_test3, y_test3, cv=10, scoring=ftwo_scorer)
#
...
#     acc_of_model_4 = cross_val_score(model, X_test4, y_test4, cv=10, scoring='accuracy')
#
...
#
# for name, model in mushroom4:
#     f1_score_of_model_4 = cross_val_score(model, X_test4, y_test4, cv=10, scoring=ftwo_scorer)
#
